 ...
 */
class UpdateSubmissionDataRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const AUTH_SECOND_FACTOR_TYPE_EMPTY = '';
    ...
    public function getAuthSecondFactorTypeAllowableValues()
    {
        return [
            ...
            self::AUTH_SECOND_FACTOR_TYPE_EMPTY,
        ];
    }
    ...
    */
    ...
    public function setAuthSecondFactorType($auth_second_factor_type)
    {
        if (is_null($auth_second_factor_type)) {
            array_push($this->openAPINullablesSetToNull, 'auth_second_factor_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('auth_second_factor_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
