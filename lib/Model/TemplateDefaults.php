...
/**
 * TemplateDefaults Class Doc Comment
 *
 * @category Class
 * @package  DocSpring
 * @author   OpenAPI Generator team
 ...
 */
class TemplateDefaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'template_defaults';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['typeface'] === null) {
            $invalidProperties[] = "'typeface' can't be null";
        }
     ...
     * Sets typeface
     *
     * @param string $typeface typeface
     *
     * @return self
     */
    ...
    {
        if (is_null($typeface)) {
            throw new \InvalidArgumentException('non-nullable typeface cannot be null');
        }
