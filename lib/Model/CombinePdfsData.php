 ...
 */
class CombinePdfsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('delete_custom_files', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($delete_custom_files)) {
            throw new \InvalidArgumentException('non-nullable delete_custom_files cannot be null');
        }
